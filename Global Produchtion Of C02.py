...
print('Production of co2 in year 20011 is',A)
print('Production of co2 in year 20012 is',B)
print('Production of co2 in year 20013 is',C)

print('\n\nPredicting a new result with Polynomial Regression')
D=lin_reg_2.predict(poly_reg.fit_transform([[2011]]))
E=lin_reg_2.predict(poly_reg.fit_transform([[2012]]))
F=lin_reg_2.predict(poly_reg.fit_transform([[2013]]))
print('Production of co2 in year 20011 is',A)
print('Production of co2 in year 20012 is',B)
print('Production of co2 in year 20013 is',C)